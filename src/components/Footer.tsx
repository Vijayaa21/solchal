        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <span className="text-2xl font-bold text-blue-400">Tech</span>
              <span className="text-2xl font-bold text-white">Learn</span>
            </div>
            <p className="text-gray-400">
              Your trusted partner in tech problem-solving and device troubleshooting.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to our newsletter for the latest tech solutions and tips.
            </p>
